        ...
        <section className={styles.testimonials}>
          ...
          <div className={styles.testimonialGrid}>
            ...
            <div className={styles.testimonialCard}>
              <div className={styles.quote}><a href="https://maps.app.goo.gl/5KrYMq2E8DMKrTnB8" target="_blank" rel="noopener noreferrer">"Dr asad awan Good doctor. He is very simple and gentle in his behavior. He will give sufficient time to each patient. He studies the patient and disease meticulously. We can freely interact with the doctor in person or on call . He prefers patient relief . I never found a commercial nature in him. My treatment includes the H pill colour,severe constipation and after consulting with a few well known homeopathic doctors from Islamabad .l consulted with Dr asad awan after just 15 days treatment I feel much better my treatment duration complete in 1 month duration now I can confidently recommend him for any stomach liver or digestive system issues .thanks once again Dr asad awan for your help and kind support during my treatment." </a></div>
