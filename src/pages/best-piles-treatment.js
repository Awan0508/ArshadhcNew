...
export async function generateMetadata() {
  return {
    ...
    openGraph: {
      title: "Stop Piles & Hemorrhoids Pain Naturally – 95% Success Rate",
      description: "Proven non-surgical solution. Permanent relief from piles pain and bleeding without complications.",
      url: "https://www.arshadhc.com/piles",
      images: [{ url: "https://www.arshadhc.com/images/piles-landing.jpg", width: 1200, height: 630 }],
    },
    twitter: {
      card: "summary_large_image",
      title: "Natural Piles & Hemorrhoids Treatment – No Surgery Needed",
      image: "https://www.arshadhc.com/images/piles-landing.jpg",
    },
  };
}

export default function PilesLanding() {
  ...
  // Piles-specific symptoms list (with icons)
  const symptomsList = [
    { symptom: "Bleeding during bowel movements", icon: "🩸" },
    { symptom: "Pain & discomfort in anal region", icon: "😫" },
    { symptom: "Itching & irritation around anus", icon: "🔥" },
    { symptom: "Swelling or lump near anus", icon: "🔴" },
    { symptom: "Pain when sitting for long periods", icon: "🪑" },
    { symptom: "Mucus discharge after bowel movement", icon: "💧" },
    { symptom: "Feeling of incomplete evacuation", icon: "🚽" },
    { symptom: "Protruding piles outside anus", icon: "👇" },
  ];
  ...
  return (
    <div className={styles.page}>
      ...
      {showEmergencyPopup && (
        ...
        >
          ...
          >
            ...
            <h3>🚨 Severe Piles Pain Right Now?</h3>
            <p>
              Get immediate guidance from our specialist doctors for fast relief from piles or hemorrhoids pain.
            </p>
        ...
        <section className={styles.hero}>
          <div className={styles.heroContainer}>
            <motion.div variants={fadeIn} initial="hidden" animate="visible" className={styles.heroText}>
              ...
              <h1>End Piles & Hemorrhoids Pain <strong><span className={styles.highlight}>Without Surgery</span></strong></h1>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.grid4}>
            <div className={styles.card}>
              ...
              <p>Heal naturally — no operation, no banding, no long recovery.</p>
            </div>
            <div className={styles.card}>
              <div className={styles.cardNumber}>2</div>
              <h3>Stops Bleeding Fast</h3>
              <p>Strengthens veins — most patients see bleeding stop within first week.</p>
            </div>
            <div className={styles.card}>
              <div className={styles.cardNumber}>3</div>
              <h3>Targets Root Cause</h3>
              <p>Treats constipation, digestion & lifestyle factors that cause piles.</p>
            </div>
            <div className={styles.card}>
        ...
        <section className={styles.sectionLight}>
          ...
          <div className={styles.testimonialGrid}>
            <div className={styles.testimonial}>
              <p>"Excellent service. Dr. Asma diagnosed accurately. 6-month course — relief in first week. Fully satisfied."</p>
              <div className={styles.testimonialAuthor}>Muhammad Jibran Sohail – Islamabad ★★★★★</div>
              <a href="https://maps.app.goo.gl/5QP7qLrNPCAv282P6" className={styles.reviewLink} target="_blank" rel="noopener noreferrer">
                Google Review
              </a>
            </div>
            ...
            <div className={styles.testimonial}>
              ...
              <a href="https://maps.app.goo.gl/wjVhVrmWZHDos9br8" className={styles.reviewLink} target="_blank" rel="noopener noreferrer">
                Google Review
              </a>
            </div>

            <div className={styles.testimonial}>
              <p>"Dr. Asma is very experienced and professional. Highly recommend everyone."</p>
              <div className={styles.testimonialAuthor}>M Tayyab Hussain ★★★★★</div>
              <a href="https://maps.app.goo.gl/q3shvaMJWPReV5cn8" className={styles.reviewLink} target="_blank" rel="noopener noreferrer">
                Google Review
              </a>
            </div>

            <div className={styles.testimonial}>
              <p>"Nice, friendly and professional doctor. Gives proper time and care to patients."</p>
              <div className={styles.testimonialAuthor}>Tauseef Khan – Islamabad ★★★★★</div>
              <a href="https://maps.app.goo.gl/Ew7uqNvmq9j7A5C48" className={styles.reviewLink} target="_blank" rel="noopener noreferrer">
                Google Review
              </a>
            </div>
          </div>
        ...
        <section className={styles.finalSection}>
          <div className={styles.finalContent}>
            ...
            <p className={styles.finalText}>
              Don't wait for the pain and bleeding to get worse. Speak to a specialist now and get guidance the same day.
            </p>
            ...
            <div className={styles.promiseList}>
              ...
              <div><RiCheckboxCircleFill /> Stops bleeding naturally</div>
      ...
      <footer className={styles.footer}>
        ...
        <p>Specialized Piles & Hemorrhoids Treatment since 2006</p>
      </footer>
